package top.chen.coupon.customer.service.impl;
...
import top.chen.coupon.customer.api.enums.CouponStatus;
import top.chen.coupon.customer.converter.CouponConverter;
import top.chen.coupon.customer.dao.CouponDao;
import top.chen.coupon.customer.dao.entity.Coupon;
import top.chen.coupon.customer.feign.CalculationService;
import top.chen.coupon.customer.feign.TemplateService;
import top.chen.coupon.customer.service.CouponCustomerService;
...
//    }
    ...
    public SimulationResponse simulateOrderPrice(SimulationOrder order) {
        ...
        // 调用接口试算服务
//        return webClientBuilder.build().post().uri("http://coupon-calculation-serv/calculator/simulate")
//                .bodyValue(order)
//                .retrieve()
...
//                })
//                .block();
        Map<Long, CouponTemplateInfo> templateMap = templateService.getTemplateInBatch();
